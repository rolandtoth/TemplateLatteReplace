...
spl_autoload_register(function ($className) {
	static $classMap = [
		...
		Latte\Runtime\Defaults::class => 'Runtime/Defaults.php',
		...
		Latte\Runtime\HtmlString::class => 'Runtime/HtmlString.php',
		Latte\Runtime\SnippetBridge::class => 'Runtime/SnippetBridge.php',
